...
public class SlimeDistanceDescision : MonoBehaviour
{
    // ------------------------------------------------
    ...
    // is running
    // ------------------------------------------------
    private SlimePatrol patrolBehaviour;
    private SlimeChase chaseBehaviour;
    ...
    void Awake()
    {
        ...
        patrolBehaviour = GetComponent<SlimePatrol>();
        // Get the EnemyPatrol that we'll be using for AI
        chaseBehaviour = GetComponent<SlimeChase>();
